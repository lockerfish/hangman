...
HangmanGame game = HangmanGame(wordList);
void main() {
  // set up event listeners
  game.onChage.listen(updateWordDisplay);
...
void createLetterButtons() {
  ...
  generateAlphabet().forEach((String letter) {
    lettersRef.append(ButtonElement()
...
List<String> generateAlphabet() {
  ...
  List<int> charCodes =
      List<int>.generate(26, (int index) => startingCharCode + index);
